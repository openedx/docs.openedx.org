...
When you add a structural block (a :ref:`section <About Course Sections>`,
:ref:`subsection <About Course Subsections>`, or :ref:`unit <About Course
Units>`) from a content library to your course, the content is linked to its
source library. In most cases, you cannot edit library-sourced content directly
in a course — but text components are an exception. You can override the text
content of any text component within a library-sourced structural block to
customize it for your course, without unlinking the rest of the block from the
library.
...
.. note::
   ...
   Text content overrides within sections, subsections, and units are available
   starting with the Verawood release of the Open edX platform.
...
.. note::
   Once you save an override, there is no indicator that marks the component as
   locally overridden. This is planned for a future release.

How Text Overrides Interact with Syncing
*****************************************

Overriding the text content of a component within a structural block (section,
subsection, or unit) changes how that component is handled during future syncs.
...
.. important::
   ...
   Unlike :ref:`standalone text component overrides <Override Text Content in a Library-Referenced Component>`,
   syncing a structural block does not give you a choice to keep or drop individual text overrides. Overridden
