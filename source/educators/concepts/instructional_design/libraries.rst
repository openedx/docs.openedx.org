.. _Legacy Content Libraries Overview:
...
.. warning::
   ...
   unsupported in Verawood. Ulmo includes a :ref:`one-click migration feature <Migrating Legacy Libraries>`
   that makes it easy to convert a Legacy Library into the new Library interface.
...
legacy content libraries<Enable Legacy Content Libraries>` in your course, you can use these
...
the library. For details, see :ref:`Give Other Users Access to Your Legacy Library`.
