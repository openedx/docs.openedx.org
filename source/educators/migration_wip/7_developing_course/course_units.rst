...
#. For the unit that you want to restrict access to, select the **Configure**
   ...
   .. image:: ../images/unit-configure-icon.png
   ...
   .. image:: ../images/unit-access-settings-gear-icon.png
...
#. In the unit's **Settings** dialog box, for the **Restrict access to**
   ...
   .. image:: ../images/unit-access-settings.png
...
4. Select the checkbox for each group for which you want the current unit to
   ...
   .. image:: ../images/unit-access-groupselected.png
...
#. Select **Save**.
   ...
   .. image:: ../images/unit-access-indicator.png
