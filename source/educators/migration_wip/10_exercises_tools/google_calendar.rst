...
For more information, see :ref:`OLX Course Building Blocks<olx course building blocks>` in the
...
information, see :ref:`OLX Course Building Blocks<olx course building blocks>` in the *EdX Open
Learning XML Guide*.
