...
Here's a simplified version of the PR process:
...
* The `Build-Test-Release WG (or BTR)
  ...
  particularly need help starting mid-Feb through June and mid-August through
  December.
...
* The `frontend working group
  ...
  upgrades. They'd love more people to join them!
...
* The `DEPR WG
  ...
  them to see if they've got anything you might be able to work on.

* The `Documentation WG
  ...
  Platform. This is a first task that is non-technical, and open to anyone who
...
and what you plan to do, link to any relevant code/screenshots, and ask
...
and local development. There's a `Tutor Topic on the discussion forums
...
Please using the `Open edX forums`_ to ask for help. First, search for your
...
Why? The Slack history is deleted after 6 months but the forums never delete
history, so your questions there will be displayed to people searching for
similar questions in the future.

Making Your First Pull Request
*******************************

When you are ready to submit changes, create a :ref:`Pull Request <Contributing
Code>`. Don't forget about :ref:`signing your CLA <Signing CLA>`!
...
#. If you did work for a working group, post your pull request in the appropriate WG Slack channel.

#. Communicate with the reviewer about the code and respond to feedback promptly.
...
repository.  Depending upon that teams priorities, it may take some time to get
...
#. If your change in still in progress or experimental, please **open the pull
   ...
   will reduce wasted attention on both sides.
...
#. `Allow admins to push commits onto your branch
   ...
   isolate those changes, but decrease the back-and-forth, which can add days to
   review times.
...
what you're working on, and ``@``-mention another GitHub user who you have been
working with who can vouch for you. If Axim grants the request, then you will
find that you're now able to manage assignees, labels, and handful of other
