...
.. note:: Most of the links to documentation provided in this glossary are to
   the `partnercoursestaff:document index` guide, for edX partners. Many
...
**A/B test**
  ...
  See `partnercoursestaff:Content Experiment`.
...
.. only:: Partners
  ...
  For more information, see `partnercoursestaff:Pub Creating and
  Announcing a Course`.
...
**course run**
  ...
  .. only:: Partners
    ...
    For more information, see `Planning Course Run Information`.
  ...
  * **honor**: This enrollment track was offered in the past and offered an
  ...
  .. only:: Partners
    ...
    * **credit**: In this enrollment track, learners who pass the course and
      ...
      `partnercoursestaff:Academic Course Credit`.
...
**LaTeX**
  ...
  typesetting program. In edX Studio, you can `partnercoursestaff:import
  LaTeX code`.
...
**math expression input problem**
  ...
  For more information, see `learners:Math Formatting` in the *EdX
  Learner's Guide*.
