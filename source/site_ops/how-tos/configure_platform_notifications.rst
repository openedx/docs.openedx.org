...
.. note::
   ...
   This is a temporary draft for restructuring the site-operator notification
   documentation. After review, its content should be folded into
   :ref:`Enable Notifications` and this page should be removed.

.. note::

   Notifications feature was rolled out in Ulmo and has been default enabled
   since Verawood release. Other changes have also been made in Verawood. See :ref:`Verawood Dev Notes`.
