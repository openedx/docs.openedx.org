...
If you click the "Details" link, you'll be brought to this page. Click the "View docs" link (NOT the
button!) to see the build - that is, the set of documentation generated by your changes:
...
different. This is a special site made just for your changes! Navigate to the page(s) you've changed
to double-check your changes look right.
