...
Link to :doc:`doc_how_to_template` in the same folder or :doc:`../quick_reference` in a different
folder.
...
.. code-block:: RST
	...
	**Unordered Lists**
	...
	Link to :doc:`doc_how_to_template` in the same folder or :doc:`../quick_reference` in a different folder.
