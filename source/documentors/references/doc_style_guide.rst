...
The Open edX docs.openedx.org repository is using a documentation markup language called reStructured Text language (RST) which is very similar to Markdown. You can check this guide which is helpful to learn how to implement such language: RST Guide: https://docs.openedx.org/en/latest/documentors/references/quick_reference_rst.html
...
Punctuation is the primary example of a convention. For specifics on punctuation use, see https://docs.openedx.org/en/latest/documentors/references/doc_english_writing.html#punctuation 
