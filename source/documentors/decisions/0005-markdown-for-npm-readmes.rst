...
* Using a placeholder README file that links to the GitHub repository README. This would
  ...
  sub-par experience when browsing Open edX published packages on `npmjs.com <npmjs.com>`__.

Consequences
************

* The READMEs for npm packages published as a part of the Open edX project will be fully rendered on `npmjs.com <npmjs.com>`__.
